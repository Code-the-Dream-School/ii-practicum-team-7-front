...
const JobSearch = () => {
  ...
  //an array of radius
  const radiusList = [1, 5, 10, 15, 25, 50];
  ...
  const handleViewApplications = () => {
    ...
    console.log("view application for job ID:", selectedJobId);
    navigate(`/jobs/${selectedJobId}/applications`);
  };
  ...
  return (
    <div>
      <div>
        ...
        <JobPostings currentJobs={currentJobs} />
